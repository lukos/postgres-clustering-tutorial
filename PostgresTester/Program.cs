    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<GeneralContext>(options =>
            {
                ...
                //options.UseNpgsql("host=192.168.56.201,192.168.56.202,192.168.56.203;port=5432;database=books;user id=books;password=bookspassword;timeout=3;");      // Using multiple hosts
            ...
            builder.Services.AddDbContext<ReadonlyContext>(options =>
            {
                ...
                //options.UseNpgsql("host=192.168.56.202,192.168.56.203,192.168.56.201;port=5432;database=books;user id=books;password=bookspassword;timeout=3;");      // Using multiple hosts
                options.UseNpgsql("host=192.168.56.201;port=5432;database=books;user id=books;password=bookspassword;timeout=3;");      // Direct to postgres1
            });
